...
const planetData = {
    'Sun': { name: '太陽', tag: '恆星', desc: '太陽系的中心，主要成分是氫與氦，佔據全系 99.8% 的質量。其核心溫度高達 1500 萬度。體積約為地球的130萬倍，太陽系所有行星都圍繞著太陽運行。', mass: '333,000 地球質量', dist: '0.00 AU', color: 0xffcc33, size: 10, orbit: 0, speed: 0 },
    ...
    'Venus': { name: '金星', tag: '行星', desc: '太陽系最熱的行星，大小與地球相近，因此被稱為「地球的姊妹星」。厚重的硫酸雲層引發極端溫室效應，壓力是地球的 90 倍。', mass: '0.815 地球質量', dist: '0.72 AU', color: 0xffd39b, size: 2.2, orbit: 38, speed: 0.025 },
    'Earth': { name: '地球', tag: '行星', desc: '目前已知唯一擁有生命的行星。具有適合生物生存的空氣、水與溫度，表面約有七成被海洋覆蓋。擁有完美的磁場防護、液態水與富含氧氣的大氣層。', mass: '1.000 基準單位', dist: '1.00 AU', color: 0x1e90ff, size: 2.4, orbit: 52, speed: 0.018 },
    'Moon': { name: '月球', tag: '衛星', desc: '地球唯一的天然衛星，自轉與公轉同步，月亮本身不會發光，月光是反射太陽光。月球表面布滿隕石坑，月亮的引力會影響地球的潮汐變化。', mass: '0.012 地球質量', dist: '384,000 km', color: 0xdddddd, size: 0.6, orbit: 5, speed: 0.06, parent: 'Earth' },
    'Mars': { name: '火星', tag: '行星', desc: '因表面富含鐵氧化物而呈現紅色，因此又被稱為「紅色星球」。科學家推測火星過去可能存在液態水，目前也是人類積極探索的目標之一。擁有太陽系最高的山脈「奧林帕斯山」與長達 4000 公里的峽谷。', mass: '0.107 地球質量', dist: '1.52 AU', color: 0xff4500, size: 1.8, orbit: 70, speed: 0.014 },
    'Jupiter': { name: '木星', tag: '行星', desc: '氣態巨行星，體積是太陽系其他行星總和的兩倍以上，保護了內太陽系免受小行星撞擊。其表面有持續數百年的巨大風暴，其中最著名的是「大紅斑」。並擁有數量眾多的衛星。', mass: '317.8 地球質量', dist: '5.20 AU', color: 0xffa54f, size: 5.5, orbit: 95, speed: 0.009 },
    'Saturn': { name: '土星', tag: '行星', desc: '擁有壯麗的環系統，光環主要由冰塊與岩石碎片組成。土星是一顆氣體巨行星，密度甚至比水還低。', mass: '95.2 地球質量', dist: '9.54 AU', color: 0xdfccaa, size: 4.8, orbit: 120, speed: 0.007, hasRing: true },
    'Uranus': { name: '天王星', tag: '行星', desc: '呈現藍綠色，主要來自大氣中的甲烷。躺著旋轉的冰巨星，其傾角高達 98 度。大氣中含有大量的冰。', mass: '14.5 地球質量', dist: '19.2 AU', color: 0x00f5ff, size: 3.2, orbit: 145, speed: 0.005 },
    'Neptune': { name: '海王星', tag: '行星', desc: '最遙遠的行星，大氣呈現深藍色，並擁有太陽系中速度極快的強烈風暴與氣流，風速可達超音速。', mass: '17.1 地球質量', dist: '30.1 AU', color: 0x4169e1, size: 3.2, orbit: 170, speed: 0.004 }
};
